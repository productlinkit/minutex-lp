...
const COMPARISON: { group: string; rows: Row[] }[] = [
  {
    ...
    rows: [
      ...
      { label: "Audio & video imports / mo", free: "3", pro: "10", business: "Unlimited" },
    ],
  },
  {
    group: "AI & transcription",
    rows: [
      { label: "Real-time transcription", free: true, pro: true, business: true },
      { label: "AI meeting summary", free: "Basic", pro: "Advanced", business: "Advanced" },
      { label: "Ask AI about your meetings", free: false, pro: true, business: true },
      { label: "Automated action items", free: false, pro: true, business: true },
      { label: "50+ languages & translation", free: false, pro: true, business: true },
      { label: "Custom vocabulary", free: false, pro: true, business: true },
    ],
  },
  {
    group: "Collaboration",
    rows: [
      ...
      { label: "Share, comment & highlight", free: true, pro: true, business: true },
